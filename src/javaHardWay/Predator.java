...
public class Predator extends ReproductionAnimal{
	...
	public static final String[] PREADTORS = {"wolf","bear","lion","bobcat"};
	
	public String getName()
	{
		return PREADTORS[(int)(Math.random()*PREADTORS.length)];
	}
	public static void main(String[] args)
	{
		Wilderness wilderness = new Wilderness("A wodded Area",10);
	...
	{
		return new Predator(habitat, getDescription(),Trait.getDominantTrait(getTrait1(), mate.getTrait2()),Trait.getDominantTrait(getTrait2(), mate.getTrait2()));
	}
